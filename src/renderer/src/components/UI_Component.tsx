 ...
 * @returns 
 */
export const Input_UI = ({texto , type , value ,name , required , funcion}:{texto:string ,name:string , type:React.HTMLInputTypeAttribute , value: any,required:boolean ,funcion:React.Dispatch<React.SetStateAction<string>>}) => (
